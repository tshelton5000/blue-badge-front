            ...
            <Background>
                ...
                <LoginDiv>
                    ...
                    <form onSubmit={this.newUser}>
                        ...
                        <br/>
                        <br/>
                        <Button style={{float: 'left'}} onClick={this.props.setScreen} onMouseOver={this.siColorOn} onMouseLeave={this.siColorOff}>To Login <span style={{color: this.state.siColor, transition: 'all 0.5s'}}>{String.fromCharCode(0x21BB)}</span></Button>
